...
@bot.command()
async def congelado(ctx,  *, keko):
    await ctx.message.delete()
    await ctx.send("Generando congelado...", delete_after=0)
    time.sleep(3)
    ...
    congelado = Image.open(r"imagenes/congelado.png").convert("RGBA") #imagen de la trozo
    img1 = congelado.resize((55,137), Image.Resampling.LANCZOS)#tamaño de congelado

 
    img1.paste(img2,(0,9), mask = img2) #Posicion del keko 
